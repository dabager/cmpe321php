...
<div class="center-div" style="width: 250px; height: 300px; background: #333333;">
    <table cellspacing="10" style="width: 200px;">
        ...
        <tr>
            <td class="center-label-td" style="font-weight: normal; font-size: 12px;">You must be logged in to do this operation.</td>
        </tr>
        <tr>
            <td>
                <a href='Login.php'>
                    <input class="btn" type="submit" value="Return to Login Page" />
                </a>
            </td>
        </tr>
    </table>
